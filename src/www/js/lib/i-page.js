...
//		u.bug_force = true;
		...
		page._default_padding = 42;
		page._default_header_height = 65;
		page._default_width = 960;
		page._default_height = 600;
		// page._default_padding = 21;
		// page._default_header_height = 32;
		// page._default_width = 480;
		// page._default_height = 300;


		page._max_width = 1600;
		page._max_height = 1000;
		// page._max_width = 800;
		// page._max_height = 500;
			...
			if(u.hc(this, "ready") && u.hc(this.scenes[0], "ready")) {
				...
				this.cN.transitioned = function() {
					...
					video.clicked = function(event) {
						...
						window.page.videoplayer.loadAndPlay("/media/movies/showreel.mp4");
...
//			u.a.translate(node, 0, -100);
		...
		page.cookie_link.clicked = function(event) {
			...
			u.a.transition(window.page.cookie_text, "all 0.5s ease-out");
